...
QT_MOC_LITERAL(9, 11), // "closeWidget"
QT_MOC_LITERAL(21, 0) // ""

    },
    "chatRoom\0closeWidget\0"
};
...
void chatRoom::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&chatRoom::closeWidget)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<chatRoom, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
